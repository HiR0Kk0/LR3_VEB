...
app.config['RECAPTCHA_PUBLIC_KEY'] = '6LeA5vEcAAAAAC5hX7oRcA32GOo8ZCAbLe8ASYYy'
app.config['RECAPTCHA_PRIVATE_KEY'] = '6LeA5vEcAAAAANEwFAy2FEJeFJrYiqKmW8XsxQKV'
...
# или неверны
    ...
    degree = FloatField('Degree of rotation', validators=[DataRequired()])
...
##открываем изображение
    ...
    img2= np.array(img.resize((height,width)))/255.0
